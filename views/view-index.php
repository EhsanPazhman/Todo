...
<!-- partial:index.partial.html -->
    ...
    <div class="main">
        ...
        <div class="welcome">
            <h1>سلام <i><?= getLoggedInUser()->name ?? null ?></i> خوش آمدید</h1>
        </div>
        <div class="welcome">
        ...
        <div class="content" style="text-align: center;">
            <ul style="display: inline-flex;">
                <?php foreach ($categories as $category): ?>
                    <a href="<?= siteUrl("$category->address") ?>?cat_id=<?= $category->id ?>" style="border: 0.5px solid blue; border-radius: 3px; padding: 8px; background: #f1f8ee; margin-left: 15px;">
